...
macro(add_withfile_AS P FN)
  ...
  endforeach()
  if ("${missing}" STREQUAL "")
    message("building target ${P} ANDROID_SHARED")
    add_library(${P} SHARED ${P}.cpp)
    install(TARGETS ${P} DESTINATION lib)
    foreach(L ${T})
      target_link_libraries(${P} ${L})
    endforeach()
    target_link_libraries(${P} goopax::goopax)
  else()
    message("not building target ${P} ANDROID_SHARED [missing: ${missing}]")
  endif()
endmacro()
...
macro(add P)
  ...
  if (${LN} GREATER 0)
    list(POP_FRONT T BT)
    if (NOT "${BT}" STREQUAL "ANDROID_SHARED")
      list(PREPEND T ${BT})
      add_withfile(${P} ${P}.cpp ${T})
    else()
      add_withfile_AS(${P} ${P}.cpp ${T})
    endif()
  else()
    add_withfile(${P} ${P}.cpp ${T})
  endif()
